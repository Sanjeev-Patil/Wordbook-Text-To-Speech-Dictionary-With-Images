...
enterwordLabel = Label(root, text='Enter Word', font=('castellar', 29, 'bold'), fg='red3', bg='FloralWhite')
...
searchButton = Button(root, image=searchimage, bd=0, bg='FloralWhite', activebackground='FloralWhite', cursor='hand2',
                      command=search)
searchButton.place(x=620, y=150)

micimage = PhotoImage(file='mic.png')
micButton = Button(root, image=micimage, bd=0, bg='FloralWhite', activebackground='FloralWhite',
                   cursor='hand2', command=wordaudio)
micButton.place(x=710, y=153)

meaninglabel = Label(root, text='Meaning', font=('castellar', 29, 'bold'), fg='red3', bg='FloralWhite')
...
audioButton = Button(root, image=audioimage, bd=0, bg='FloralWhite', activebackground='FloralWhite',
                     cursor='hand2', command=meaningaudio)
audioButton.place(x=530, y=555)

clearimage = PhotoImage(file='clear.png')
clearButton = Button(root, image=clearimage, bd=0, bg='FloralWhite', activebackground='FloralWhite', cursor='hand2'
                     , command=clear)
clearButton.place(x=660, y=555)

exitimage = PhotoImage(file='exit.png')
exitButton = Button(root, image=exitimage, bd=0, bg='FloralWhite', activebackground='FloralWhite', cursor='hand2',
                    command=iexit)
